        ...
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route("profile.password.updateProfile") }}">
                    ...
                    <div class="form-group">
                        <label class="" for="title">{{ trans('cruds.user.fields.bu') }}</label>                        
                            @foreach($user->bu as $key => $value)
                            <input class="form-control" type="text" name="bu" id="bu" value="{{ $value->name }}" readonly>
                            @endforeach
                    </div>
                    <div class="form-group">
                        <label class="" for="title">{{ trans('cruds.user.fields.dept') }}</label>                        
                            @foreach($user->dept as $key => $value)
                            <input class="form-control" type="text" name="dept" id="dept" value="{{ $value->name }}" readonly>
                            @endforeach
                    </div>
                    <div class="form-group">
