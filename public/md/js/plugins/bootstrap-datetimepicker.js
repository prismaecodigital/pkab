     ...
     var dpgId = 0,
       ...
       DateTimePicker = function(element, options) {
         var defaults = {
             ...
             useSeconds: false,
             useCurrent: true,
             /* RQI: Auto fill Current Date as Default when Showing */
             minuteStepping: 1,
             startDate: new pMoment({
               y: 1970
             }),
           ...
           isInDisableDates = function(date) {
             ...
             var disabled = picker.options.disabledDates,
               i;
             for (i in disabled) {
           ...
           isInEnableDates = function(date) {
             pMoment.lang(picker.options.language);
             var enabled = picker.options.enabledDates,
               i;
             if (enabled.length) {
               for (i in enabled) {
